...
(function() {
    ...
    function De(e, r) {
        ...
        function s(f) {
            ...
            for (; g && (g = 0, f[0] && (a = 0)), a;)
                try {
                    if (o = 1, c && (u = f[0] & 2 ? c.return : f[0] ? c.throw || ((u = c.return) && u.call(c), 0) : c.next) && !(u = u.call(c, f[1])).done)
                        return u;
    ...
    var bt = function(e) {
            var r,
                ...
                u,
                g = k(Or, (u = (r = e.displayLanguage) === null || r === void 0 ? void 0 : r.toLowerCase()) !== null && u !== void 0 ? u : "nonexistent"),
                _,
                s = k(Cr, (_ = (a = e.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !== null && _ !== void 0 ? _ : "nonexistent");
            return o ? Nr({
    ...
    function Et() {
        ...
        if (U(r, HTMLScriptElement) && e.test(r.src))
            return r;
        for (var a = document.querySelectorAll("script"), o = 0, c; c = a[o]; o++)
            if (U(c, HTMLScriptElement) && e.test(c.src))
                return c
    }
    function sr() {
        var e = Et();
    ...
    var xt = function(e, r) {
            var a = ht(r.params, !1),
                ...
                c,
                u,
                g = "".concat(a, "/cdn-cgi/challenge-platform/").concat(o, "feedback-reports/").concat(qe(e), "/").concat(r.displayLanguage, "/").concat((c = r.params.theme) !== null && c !== void 0 ? c : r.theme);
            r.wrapper.parentNode || v("Cannot initialize Widget, Element not found (#".concat(e, ")."), 3074);
            var _ = document.createElement("div");
            _.style.position = "fixed",
            _.style.zIndex = "21474836419";
            ...
            f.setAttribute("allow", "cross-origin-isolated; fullscreen"),
            f.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups allow-forms"),
            ...
            E.style.width = "26px",
            E.style.height = "26px",
            E.style.zIndex = "21474836421",
            E.style.cursor = "pointer",
            r.displayRTL ? E.style.left = "6px" : E.style.right = "2px",
            E.style.top = "5px",
            ...
            I.setAttribute("ry", "12"),
            I.setAttribute("rx", "12"),
            I.setAttribute("cy", "12"),
            I.setAttribute("cx", "12"),
            ...
            A.setAttribute("stroke", "#999"),
            A.setAttribute("fill", "none"),
            A.setAttribute("x1", "6"),
            A.setAttribute("x2", "18"),
            A.setAttribute("y1", "5"),
            ...
            s.appendChild(E),
            _.appendChild(s),
            r.wrapper.parentNode.appendChild(_),
    ...
    function Ot() {
        var e = [Yt, Kt];
        h.isRecaptchaCompatibilityMode && e.push(Qt),
        ...
        var e = function(n, i, t, d) {
            ...
            r = function(n, i, t) {
                if (n.params.retry === fe.AUTO || t) {
                    ...
                    var d,
                        l = t ? 0 : 1e3 * 2 + ((d = n.params["retry-interval"]) !== null && d !== void 0 ? d : 0);
            ...
            a = function(n, i, t) {
                ...
                n.isComplete = !0,
                Er(i, n.response),
                (d = n.cbSuccess) === null || d === void 0 || d.call(n, n.response, t)
            },
            o = function(n) {
                if (!n)
                    return [];
                for (var i = n.attributes, t = i.length, d = new Array(t), l = 0; l < t; l++)
                    d[l] = i[l].name;
                return d
            },
            c = function(n, i, t) {
            ...
            s = function(n, i) {
                if (i) {
                    ...
                    i.action && (ut(i.action) || v('Invalid input for optional parameter "action", got "'.concat(i.action, '"'), 3604), n.action = i.action),
                    i.cData && (lt(i.cData) || v('Invalid input for optional parameter "cData", got "'.concat(i.cData, '"'), 3605), n.cData = i.cData),
            ...
            f = function(n) {
                ...
                if (t) {
                    ...
                    t.watchcat.seq = 0,
                    t.params.execution === pe.RENDER && (t.msgQueue.push(oe.EXECUTE), t.isExecuted = !0, t.isExecuting = !0);
                    var d = K(i),
                        l = t.shadow.querySelector("#".concat(d));
                    (!d || !l) && v("Widget ".concat(i, " to reset was not found."), 3330),
                    t.params.appearance === X.INTERACTION_ONLY && hr(l),
                    t.params.sitekey === null && v("Unexpected Error: Sitekey is null", 3347);
                    var m;
                    l.src = yt(i, t.params.sitekey, t.params, (m = t.rcV) !== null && m !== void 0 ? m : Y, !1, "g", gt(t)),
                    At(d),
                    t.retryTimeout && window.clearTimeout(t.retryTimeout)
                } else
                    v("Widget ".concat(i, " to reset was not found."), 3331)
            },
            E = function(n) {
                var i,
                    t = C(n);
            ...
            I = function(n, i) {
                ...
                if (typeof n == "string")
                    try {
                        ...
                        x || v('Unable to find a container for "'.concat(n, '"'), 3585),
                        m = x
                    } catch (Ft) {
                        v('Invalid type for "container", expected "selector" or an implementation of "HTMLElement", got "'.concat(n, '"'), 3586)
                    }
                else
                    U(n, HTMLElement) ? m = n : v('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
                var w = !0,
                    T = !1,
                    R = void 0;
                try {
                ...
                if (M) {
                    ...
                    typeof H != "string" && v('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof H == "undefined" ? "undefined" : F(H), '"'), 3588),
                    qt(H) || v('Invalid input for parameter "sitekey", got "'.concat(H, '"'), 3589),
                    st(p.size) || v('Invalid type for parameter "size", expected normal|compact, got "'.concat(p.size, '" ').concat(F(p.size)), 3590),
                    nt(p.theme) || v('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(p.theme, '" ').concat(F(p.theme)), 3591),
                    it(p.retry) || v('Invalid type for parameter "retry", expected never|auto, got "'.concat(p.retry, '" ').concat(F(p.retry)), 3592),
                    p.language || (p.language = "auto"),
                    pt(p.language) || (b('Invalid language value: "'.concat(p.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US).")), p.language = "auto"),
                    vt(p.appearance) || v('Unknown appearance value: "'.concat(p.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600),
                    mt(p.execution) || v('Unknown execution value: "'.concat(p.execution, ", expected either: 'render' or 'execute'."), 3601),
                    ot(p["retry-interval"]) || v('Invalid retry-interval value: "'.concat(p["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602),
                    ct(p["expiry-interval"]) || v('Invalid expiry-interval value: "'.concat(p["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                    var we,
                        Q = (we = p["refresh-expired"]) !== null && we !== void 0 ? we : $.AUTO;
                    ...
                    var Te,
                        ne = (Te = p["refresh-timeout"]) !== null && Te !== void 0 ? Te : ie.AUTO;
                    ...
                    ut(ge) || v('Invalid input for optional parameter "action", got "'.concat(ge, '"'), 3604),
                    lt(ee) || v('Invalid input for optional parameter "cData", got "'.concat(ee, '"'), 3605);
                    var Re = u(),
                        de = K(Re);
                    if (!(!Re || !de)) {
                        var Lt = [],
                            Ke = p.execution === pe.RENDER;
                        Ke && Lt.push(oe.EXECUTE),
                        h.lastWidgetIdx++;
                        var xr = {};
                        ...
                        Qe || v("Turnstile Initialization Error ", 3606),
                        B.style.display = "none",
                        B.style.border = "none",
                        B.style.overflow = "hidden",
                        B.setAttribute("src", yt(Re, H, p, Y, !1, "g", gt(Qe))),
                        B.onerror = function() {
                            if (G) {
                        ...
                        var Mt = ["cross-origin-isolated", "fullscreen", "autoplay"],
                            $e;
                        k(($e = (d = document.featurePolicy) === null || d === void 0 || (t = d.features) === null || t === void 0 ? void 0 : t.call(d)) !== null && $e !== void 0 ? $e : [], _t) && Mt.push(_t),
                        B.setAttribute("allow", Mt.join("; ")),
                        B.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                        B.id = de;
                        var Je;
                        B.tabIndex = (Je = p.tabindex) !== null && Je !== void 0 ? Je : 0,
                        B.title = "Widget containing a Cloudflare security challenge",
                        kt.appendChild(B);
                        var Ze,
                            wr = (Ze = p["response-field"]) !== null && Ze !== void 0 ? Ze : !0;
                        if (wr) {
        ...
        function A() {
            return A = Ut(function(y, n, i, t) {
                ...
                return De(this, function(M) {
                    switch (M.label) {
                    case 0:
                        if (d = y.params.sitekey, l = yr(), !l)
                            return b("Cannot determine Turnstile's embedded location, aborting clearance redemption."), a(y, n, !1), [2];
                        m = "h/".concat("g", "/"),
                        x = new URL(l),
                        w = "https",
                        T = "",
                        R = "".concat(w, "://").concat(x.host, "/cdn-cgi/challenge-platform/").concat(m, "rc/").concat(t).concat(T),
                        M.label = 1;
                    case 1:
                    ...
                    case 3:
                        return [4, L.json()];
                    case 4:
                        if (W = M.sent(), "status" in W && W.status === "redeemed")
                            return a(y, n, !0), [2];
                        M.label = 5;
                    case 5:
                        return [3, 7];
                        ...
                        case "init":
                            {
                                ...
                                l || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                t.mode = n.mode,
                                t.nextRcV = n.nextRcV,
                                t.mode === j.INVISIBLE && t.params["refresh-expired"] === $.MANUAL && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat($.AUTO, "' or '").concat($.NEVER, ".'")),
                                t.mode !== j.MANAGED && t.params["refresh-timeout"] !== ie.AUTO && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                t.params.appearance === X.ALWAYS || t.isExecuting && t.params.appearance === X.EXECUTE ? It(l, t) : hr(l),
                                l.style.display = "";
                                var m = t.shadow.querySelector("#".concat(i));
                                m || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (d = m.contentWindow) === null || d === void 0 || d.postMessage({
                                    source: P,
                                    widgetId: n.widgetId,
                                    event: "init"
                                }, "*");
                            ...
                            {
                                b("Language ".concat(t.params.language, " is not supported, falling back to: ").concat(n.fallback, ".")),
                            ...
                            }case "fail":
                            {
                                ...
                                if (W) {
                                    var Z,
                                        M = t.shadow.querySelector("#".concat(i));
                                ...
                                if (L) {
                                    ...
                                    n.code ? (r(t, i, W), v("Error: ".concat(n.code), 3076)) : r(t, i, !1);
                                break
                            }case "feedbackInit":
                            {
                            ...
                            }case "requestFeedbackData":
                            {
                                ...
                                Oe || v("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                            ...
                            }case "turnstileResults":
                            {
                                var H,
                                    te,
                                    ue = (H = t.wrapper.parentNode) === null || H === void 0 ? void 0 : H.querySelector("#".concat(i, "-fr"));
                                ue || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (te = ue.contentWindow) === null || te === void 0 || te.postMessage({
                                    source: P,
                                    widgetId: n.widgetId,
                                    event: "feedbackData",
                                    rayId: n.rayId,
                            ...
                            {
                                var re,
                                    _e = (re = t.wrapper.parentNode) === null || re === void 0 ? void 0 : re.querySelector("#".concat(i, "-fr"));
                                _e || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                dr("".concat(i, "-fr"));
                                break
                            }case "tokenExpired":
                            {
                                var ae,
                                    he = n.token;
                                t.isExpired = !0,
                                (ae = t.cbExpired) === null || ae === void 0 || ae.call(t, he),
                            ...
                            }case "interactiveBegin":
                            {
                                ...
                                Ce || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (be = t.cbBeforeInteractive) === null || be === void 0 || be.call(t),
                                t.params.appearance === X.INTERACTION_ONLY && It(Ce, t);
                                break
                            }case "interactiveEnd":
                            {
                                var Ee;
        ...
        return tt(Fe({}, q), {
            ...
            execute: function(n, i) {
                ...
                if (!t) {
                    ...
                    var d = I(n, i);
                    d || v("Failed to render widget", 43522),
                    t = d
                }
                ...
                if (l) {
                    ...
                    if (l.response) {
                        var x;
                        l.isExecuting = !1,
                        b("Call to execute() on a widget that was already executed (".concat(m, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token.")),
                        (x = l.cbSuccess) === null || x === void 0 || x.call(l, l.response, !1);
                        return
                    }
                    l.isExpired && b("Call to execute on a expired-widget (".concat(m, "), consider using reset() before.")),
                    l.isStale && (f(m), l.isExecuting = !0),
                    l.msgQueue.push(oe.EXECUTE),
                    l.isExecuted = !0;
                    var w = l.shadow.querySelector("#".concat(m));
                    if (w || (l.isExecuting = !1, v("Widget ".concat(m, " to execute was not found"), 43522)), l.isResetting)
                        return;
                    if (l.isInitialized && _(l, t, w), l.isInitialized && l.params.appearance === X.EXECUTE && It(w, l), l.isExecuting) {
                        var T,
                            R = l.shadow.querySelector("#".concat(m));
                        R || v("Received state for an unknown widget: ".concat(t), 3078),
                        (T = R.contentWindow) === null || T === void 0 || T.postMessage({
                            source: P,
                            widgetId: t,
                            event: "execute"
                        }, "*")
    ...
    function Vr(e) {
        ...
        if (u && (st(u) ? a.size = u : b('Unknown data-size value: "'.concat(u, '".'))), 0)
            var g;
        ...
        var t,
            d = (t = e.getAttribute("data-response-field")) !== null && t !== void 0 ? t : "true";
