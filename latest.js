...
!function(l, t, e, n, p) {
    try {
        ...
        if (qt.sri = d, D && (qt.mobile = D.mobile, qt.brands = S(D.brands)), y.doctype || p("Add DOCTYPE html for accurate dimensions"), ft !== v && (qt.hostname_original = v), !_t && c in g && "1" == g[c])
        ...
        var $t,
            ...
            Rt = function(t, e) {
                ...
                At && (n = Z(dt, {
                    type: "append",
                    original_id: e ? t : qt.page_id
                }), tt("t") && (n.duration = Math.round((et() - gt - Ht) / 1e3)), Ht = 0, gt = et(), tt("scro") && (n.scrolled = Math.max(0, vt, Tt())), e || !g.sendBeacon ? pt(n, h, f) : g.sendBeacon(k + "/append", S(n)))
            };
        ...
        var Pt = y.body || {},
            Tt = function() {
                try {
                    var t = A[R] || 0,
                        e = Math.max(Pt[C] || 0, Pt[H] || 0, A[R] || 0, A[C] || 0, A[H] || 0);
                    return Math.min(100, 5 * Math.round(100 * ((A.scrollTop || 0) + t) / e / 5))
                } catch (ne) {
                    return p(ne), 0
                }
            };
        ...
        var Ut,
            ...
            Nt = function(t, e, n) {
                ...
                if (r && $t != r) {
                    $t = r,
                    Dt.path = r,
                    tt("v") && (Dt.viewport_width = Math.max(A.clientWidth || 0, l.innerWidth || 0) || null, Dt.viewport_height = Math.max(A[R] || 0, l.innerHeight || 0) || null),
                    tt("l") && g[q] && (Dt[q] = g[q]),
